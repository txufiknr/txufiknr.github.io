// from: https://codepen.io/Yakudoo/pen/GxKmQY
...
class Stargate {
  constructor(width, height) {
    ...
    this.renderer.domElement.id = 'stargate';
  ...
  createPlane(){
    ...
    this.tunnelGeometry = new THREE.CylinderGeometry( 40, 40, 250, 50, 1, true);
		this.tunnelGeometry.applyMatrix( new THREE.Matrix4().makeRotationX(Math.PI/2));
...
function domIsReady() {
    stargate = new Stargate(this.container, this.renderer, window.innerWidth, window.innerHeight);
...
function handleWindowResize() {
    stargate.updateSize(window.innerWidth, window.innerHeight);
}
